...
const EN = {
  ...
  results_warn: "All values in this section are taken directly from results/metrics.json, produced by the pipeline on the open PhysioNet/CinC 2019 dataset (seed 42; 8-hour window, 6-hour lead time; see config.yaml). No numbers were carried over from any earlier abstract.",
  results: [
...
const ID = {
  ...
  results_warn: "Seluruh nilai pada bagian ini diambil langsung dari results/metrics.json, yang dihasilkan pipeline pada dataset terbuka PhysioNet/CinC 2019 (seed 42; jendela 8 jam, lead time 6 jam; lihat config.yaml). Tidak ada angka yang dipindahkan dari abstrak sebelumnya.",
  results: [
